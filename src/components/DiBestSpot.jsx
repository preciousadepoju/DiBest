    ...
    <div>
        <div className='buttonCont'>
                ...
                <div className='btnFather mt-3  '>
                    ...
                    <button type="button" class="focus:outline-none text-white bg-[#A78236] hover:bg-yellow-600 focus:ring-yellow-300 font-medium text-sm px-5 py-2 h-10 mt-1.5 ms-2  " style={{width:'40%'}}><a href='#'>Egift</a></button>
